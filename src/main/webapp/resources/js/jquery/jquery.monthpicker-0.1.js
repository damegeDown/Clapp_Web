...
(function($){
	$.fn.monthPicker = function(opt){
		var input = null;
		var curYear = null;
		var pop = $("<div><div class='year'><span><a class='changeYear' data-amount='-1'>◀</a></span><strong class='curYear'></strong><span><a class='changeYear' data-amount='1'>▶</a></span></div><ul id='monthList'></ul></div>").addClass("monthPicker");
		...
		pop.find("#monthList li").click(function(){
			input.val(curYear + "" + $(this).data("month").zf(2)).focus();
			pop.hide();
		});
	};
})(jQuery);