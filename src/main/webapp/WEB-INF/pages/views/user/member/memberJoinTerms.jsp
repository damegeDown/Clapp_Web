      ...
      <div class="subJoinPrivacyBox">
        ...
        <div class="sjPrivacy" readonly>
          ...
          <h3>제1조 (수집하는 개인정보의 항목 및 수집 방법)</h3>
              ...
              회사가 수집하여 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용하지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 것입니다.<br />
              1. 회원 관리<br />
              1) 회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의 부정이용 방지와 비인가 사용 방지, 가입의사 확인, 연령확인, 불만처리 등 민원처리, 고지사항 전달<br /><br />
              2. 개인정보 처리 및 정보주체의 개인정보 열람, 정정, 삭제, 처리정지 요구 시 본인 확인을 위함<br /><br />
              3. 마케팅 및 광고에 활용<br />
              1) 신규 서비스(제품) 개발 및 특화, 이벤트 등 광고성 정보 전달, 인구 통계학적 특성에 따른 서비스 제공 및 광고 게재, 접속 빈도 파악 또는 회원 서비스 이용에 대한 통계<br /><br />
              4. 서비스 및 콘텐츠 제공에 관한 계약 이행<br />
