      ...
      <div class="subTRIndustryContentBtnBox">
        <div class="subTRIndustryContentBtn">
          <div class="subTRIndustryContentBtnList">
            <%-- <a href="${contextPath}/trandReview/reviewList"> --%>
            <a href="${contextPath}/trandReview/reviewList?currentPage=${boardEntity.currentPage}&mvType=detail#boardKey${trandReviewDetail.boardTrandKey}">
          ...
          <div class="subTRIndustryContentBtnBack">
           <c:if test="${trandReviewDetail.trandPrevPage > 0}">
            <a href="${contextPath}/trandReview/reviewDetail?currentPage=${boardEntity.currentPage}&boardTrandKey=${trandReviewDetail.trandPrevPage}">
          ...
          <c:if test="${trandReviewDetail.trandNextPage > 0}">
            <a href="${contextPath}/trandReview/reviewDetail?currentPage=${boardEntity.currentPage}&boardTrandKey=${trandReviewDetail.trandNextPage} "><img src="${contextPath}/resources/images/contents_btn_next_board.png"  onmouseover="this.src='${contextPath}/resources/images/contents_btn_next_board_r.png';" onMouseOut="this.src='${contextPath}/resources/images/contents_btn_next_board.png';" alt="next" /></a>
          </c:if>
