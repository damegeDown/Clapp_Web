              ...
              <div class="subTRIndusrtyContentListRow direct" id="boardKey${boardTrandList.boardTrandKey}">
                <div class="subTRIndusrtyContentImgBox">
                  <div class="subTRIndusrtyContentImg">
                    <a class="trandReviewDetail" href="javascript:;" data-url="trandDetail" data-key="${boardTrandList.boardTrandKey}">
                  ...
                  <a class="trandReviewDetail" href="javascript:;" data-url="trandDetail" data-key="${boardTrandList.boardTrandKey}">
                  <%-- <a href="${contextPath}/trandReview/trandDetail?boardTrandKey=${boardTrandList.boardTrandKey }"> --%>
        ...
        <div class="subTRIndusrtyContentBottomBox">
          <div class="subTRIndusrtyContentMoreImgBox">
            <div class="subTRIndusrtyContentMoreImg">
              <span class="nextPage" data-url="trandList" alt="">
...
/*   $(window).scroll(function() {
  ...
  /* function scrollPage() { */
    $(".nextPage").on("click", function() {
      ...
      $.ajax({
          /* url : 'rest/'+url , */
          url : contextPath + 'rest/trandList',
          dataType : 'json',
          ...
          success : function(result) {
            ...
            for(var i = 0; i < resultList.length; i++){
              ...
              contents += "<div class='subTRIndusrtyContentListRow'>"+
                            "<div class='subTRIndusrtyContentImgBox'>"+
                              "<div class='subTRIndusrtyContentImg'>"+
                                "<a class='trandReviewDetail' href='javascript:;'data-url='trandDetail' data-key='" + resultList[i].boardTrandKey + "'>"+
