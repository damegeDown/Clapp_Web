        ...
        <div class="subMTGnbBottomBox">
          <div class="subMTGnbBottom">
            <ul>
              ...
              <li></li>
              <li class="smtgbItem2"><a href="${contextPath}/trandReview/trandList" class="smtGRTr smtGRTrActive">업계 동향</a></li>
              <li></li>
      ...
      <div class="subTRIndustryGnbBottomBg">
        <div class="subTRIndustryGnbBottomBox">
          <div class="subTRIndustryGnbBottom">
            <span class="subTRIndustryTitle">업계 동향</span>
      ...
      <div class="subTRIndustryContentBtnBox">
        <div class="subTRIndustryContentBtn">
          <div class="subTRIndustryContentBtnList">
            <%-- <a href="${contextPath}/trandReview/trandList"> --%>
          <a href="${contextPath}/trandReview/trandList?currentPage=${boardEntity.currentPage}&mvType=detail#boardKey${trandReviewDetail.boardTrandKey}">
          ...
          <div class="subTRIndustryContentBtnBack">
           <c:if test="${trandReviewDetail.trandPrevPage > 0}">
            <a href="${contextPath}/trandReview/trandDetail?currentPage=${boardEntity.currentPage}&boardTrandKey=${trandReviewDetail.trandPrevPage}">
          ...
          <c:if test="${trandReviewDetail.trandNextPage > 0}">
            <a href="${contextPath}/trandReview/trandDetail?currentPage=${boardEntity.currentPage}&boardTrandKey=${trandReviewDetail.trandNextPage} "><img src="${contextPath}/resources/images/contents_btn_next_board.png"  onmouseover="this.src='${contextPath}/resources/images/contents_btn_next_board_r.png';" onMouseOut="this.src='${contextPath}/resources/images/contents_btn_next_board.png';" alt="next" /></a>
          </c:if>
