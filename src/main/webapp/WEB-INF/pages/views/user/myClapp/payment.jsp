				...
				<tr> 
					<td class="td prName">
					  ...
					  <div class="prMP2"  style="width:20px">
						<c:if test="${productInfo.productMasterKey > 2 && productInfo.productMasterKey < 8 }">
					...
					<td class="td"> &#8361;<fmt:formatNumber value="${productInfo.productPrice }" />
					...
					<td class="td totalPrice">&#8361; <span class="totalPriceNum"><fmt:formatNumber value="${productInfo.productPrice + (productInfo.productPrice * 0.1)}" /></span></td>
				</tr>
			</table>
		</div>
	</div>
...
<div class="subJoinTermsPrivacyNextContainer">
	<div class="subJoinTermsPrivacyNextButtonBox2">
			<img src="${contextPath }/resources/images/buttons_payment.png" onclick="PaymentUtils.doPayment()" onMouseOver="this.src='${contextPath }/resources/images/buttons_payment_r.png';" onMouseOut="this.src='${contextPath }/resources/images/buttons_payment.png';" alt="결제" />
