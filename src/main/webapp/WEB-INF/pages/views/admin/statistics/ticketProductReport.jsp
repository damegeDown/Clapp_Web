...
<div class="sub-content">
  ...
  <div style="margin:5px; color:red">* 티켓 / 상품 적용 서비스 통계는 월간으로만 검색 가능합니다.</div>
  <div style="margin:5px; color:red">* 개별 계정에 부여된 건수에는 별도 계약 건이 포함되어 있습니다. 상세 적용 내역을 보시려면 티켓/상품 관리 > 티켓/상품 적용 서비스에서 확인 바랍니다.</div>
