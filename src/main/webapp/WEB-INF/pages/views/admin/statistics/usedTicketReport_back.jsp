	...
	<table class="board-list-r">
		...
		<c:forEach items="${statisticsDateList.statisticsList }" var="statisticsDateList" varStatus="i">
			...
			<tr class="cursor" style="cursor:pointer; ${color} ">
				...
				<!-- 기업/단체가입 -->
				<td>
					<fmt:formatNumber value="${(statisticsDateList.usedTicketCompanyMember / (statisticsDateList.usedTicketMember + statisticsDateList.usedTicketCompanyMember)) * 100 }" type="number" pattern="##,###.##"/> %
				</td> 
				<!-- 일별합계 -->
				<td>
					<c:if test="${statisticsDateList.dayOfWeek < 5 }">
		...
		<tfoot> 
		 <tr class="first"> 
		 	...
		 	<td><fmt:formatNumber value="${(aveWeekDayUsedTicketMember / (aveWeekDayUsedTicketMember + aveWeekDayUsedTicketCompanyMember)) * 100 }" type="number" pattern="##,###.##"/> %</td>
		 ...
		 <tr>
		 	...
		 	<td><fmt:formatNumber value="${(aveTotalUsedTicketMember / (aveTotalUsedTicketMember + aveTotalUsedTicketCompanyMember)) * 100 }" type="number" pattern="##,###.##"/> %</td>
		 ...
		 <tr class="last">
		 	...
		 	<td><fmt:formatNumber value="${(sumCompanyMember / (sumMember + sumCompanyMember)) * 100 }" type="number" pattern="##,###.##"/> %</td>
	...
	<table class="board-list-r">
		...
		<c:forEach items="${statisticsTimeList.statisticsList }" var="statisticsTimeList" varStatus="i">
			<tr class="cursor" style="cursor:pointer; ${color} ">
				...
				<!-- 기업/단체가입 -->
				<td>
					${statisticsTimeList.aveUsedTicket } %
				</td> 
				<!-- 일별합계 -->
				<td>
	...
	<table class="board-list-r">
		...
		<c:forEach items="${statisticsDeviceList.statisticsList }" var="statisticsDeviceList" varStatus="i">
			<tr class="cursor" style="cursor:pointer; ${color} ">
				...
				<!-- 기업/단체가입 -->
				<td>
					${statisticsDeviceList.aveUsedTicket } %
				</td> 
				<!-- 일별합계 -->
				<td>
