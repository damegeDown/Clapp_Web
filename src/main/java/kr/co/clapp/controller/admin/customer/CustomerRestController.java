...
//
	...
	public ResponseEntity insertBoardNotice(BoardNoticeEntity boardNoticeEntity) {
      ResponseEntity result = new ResponseEntity();
	  try {
		String resultCode = ResultCode.FAIL;
		String resultMessage = messages.getMessage("insert.fail");
	...
	public ResponseEntity modifyBoardNotice(BoardNoticeEntity boardNoticeEntity) {
      ResponseEntity result = new ResponseEntity();
	  try {
		String resultCode = ResultCode.FAIL;
		String resultMessage = messages.getMessage("modify.fail");
	...
	public ResponseEntity insertBoardQna(BoardQnaEntity boardQnaEntity) {
      ResponseEntity result = new ResponseEntity();
	  try {
		String resultCode = ResultCode.FAIL;
		String resultMessage = messages.getMessage("insert.fail");
	...
	public ResponseEntity modifyBoardQna(BoardQnaEntity boardQnaEntity) {
      ResponseEntity result = new ResponseEntity();
	  try {
		String resultCode = ResultCode.FAIL;
		String resultMessage = messages.getMessage("modify.fail");
