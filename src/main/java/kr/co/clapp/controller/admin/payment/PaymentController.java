...
public class PaymentController {
  ...
  public String paymentContractList (PaymentEntity paymentEntity, Model model) {
    try{
      ...
      commonCode.put("searchResult", "> 검색결과 : <span class='colorSkyBlue'>"+paymentEntity.getDataSize()+"</span> 건 /  <span class='colorSkyBlue'>"+String.format("%,d", paymentEntity.getSumTotalPrice())+"</span> vat 별도");   // 검색 결과
      commonCode.put( "mainMenu", "permissionPayment" );                      // left main menu
